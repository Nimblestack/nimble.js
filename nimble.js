...
//            );
        ...
        getWithFile: function (Filedata, callback, index) {
           ...
           //  console.log(Filedata);
            ...
            var postUrl =  this.BaseUrl + ".json?update&PHPSESSID=" + this.getSession(index);
            console.log(postUrl);
            $.ajax({
                type: "POST",
                url: postUrl,
...
//            );
            $.ajax({
                type: "GET",
                url: _nml.BaseUrl + "/login/logout.json?PHPSESSID=" + sessid,
                crossDomain: true,
                success: function (data) {
                    next(data);
                },
        ...
        RunLoginSequence:function(index, userEmail, userPassword, callback, _nml){
            _nml._tmp_email = userEmail;
            _nml._tmp_password = userPassword;
        ...
        onLogin: function (data) {
            ...
            if (data.success === true || data.success === "true") {
                // save the session
                console.log("SETTING SESSION: " + this.loginIndex);
         ...
         * @inner
         */
        manageAuthRedirect: function (_nml, callback) {
            // show redirect modal
